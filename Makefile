...
GENERATED_FILES = \
	...
	$(STROKES:strokes/%.json=assets/strokes/jpg/%-0.jpg) \
	$(STROKES:strokes/%.json=assets/strokes/jpg/%-30-1.jpg) \
	$(STROKES:strokes/%.json=assets/strokes/jpg/%-50-1.jpg) \
	$(STROKES:strokes/%.json=assets/strokes/jpg/%-65-1.jpg) \
	$(STROKES:strokes/%.json=assets/strokes/jpg/%-90-1.jpg) \
